...
class CommunityAccountTest {
    ...
    HashMap<String,String> expectedAccountDetails = new HashMap<>(Map.of("customerID","123", "accountType", "Community", "accountNumber","12345678", "currentBalance","308.50", "overdraftLimit","2500.00", "signatories","0"));
    ...
    void constructorFromHashMap() {
        Account account = new CommunityAccount(testAccountDetails);
    ...
    void constructorFromCustomer() {
        ...
        Account account = new CommunityAccount(customer);
    ...
    void getAndSetMethods() {
        ...
        assertEquals("Community", account.getAccountType());
        assertEquals("12345678", account.getAccountNumber());
        assertEquals("2500.00", account.getOverdraftLimit());
