...
class PendingTransactionTest {
    HashMap<String,String> testData = new HashMap<>(){{
       put("transactionID","123456"); put("accountNumber","987654"); put("signatoryID","19821"); put("transactionAmount","34.56"); put("transactionType","Deposit");
    }};
    HashMap<String,String> amendedData = new HashMap<>(){{
        put("transactionID","987654"); put("accountNumber","111111"); put("signatoryID","666666"); put("transactionAmount","98.67"); put("transactionType","Withdrawal");
    }};
